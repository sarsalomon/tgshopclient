    ...
    return (
        <div>
            <Container>
                <Row>
                    <Col>
                    <NavLink to={ADD_PRODUCT_ROUTER}><Button variant='success'>Add Product</Button></NavLink>
                    </Col>
                    <Col>
                        <Form.Select
                            ...
                            currentItem.map((product, index) => 
                                ...
                                >
                                    ...
                                    <td>
                                        ...
                                        <Button variant="danger" className="ms-2" onClick={() => deleteP(product._id)}>delete</Button>
                                    </td>
                                </tr>
                           )
                        }
